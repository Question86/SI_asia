...
_Generated: 2026-08-20T03:49:29Z_
...
- Dynamics score: `26.0`
- Published: `2026-08-20T10:00:00+09:00` / age_days `0.12`
...
- Dynamics score: `24.9`
- Published: `2026-08-20T02:37:02+00:00` / age_days `0.05`
- Vergleich: Die Dynamik liegt über Normalniveau und verdient aktive Beobachtung.
- Senna: Security zuerst. Exposure prüfen, Patchstand sichern, dann erst über Narrative reden.
...
- Band: `strong` (raw `extreme`)
- Dynamics score: `24.9`
- Published: `2026-06-19T01:58:32+00:00` / age_days `62.08`
- Vergleich: Die Dynamik liegt über Normalniveau und verdient aktive Beobachtung.
- Senna: Security zuerst. Exposure prüfen, Patchstand sichern, dann erst über Narrative reden.
...
- Dynamics score: `24.9`
- Published: `2026-08-20T03:12:09.708+00:00` / age_days `0.03`
- Vergleich: Die Dynamik liegt über Normalniveau und verdient aktive Beobachtung.
...
- Band: `strong` (raw `strong`)
- Dynamics score: `23.0`
- Published: `2026-08-20T03:15:43.040+00:00` / age_days `0.02`
- Vergleich: Die Dynamik liegt über Normalniveau und verdient aktive Beobachtung.
- Senna: Beobachten, nicht aufblasen.
...
- Dynamics score: `19.0`
- Published: `2026-08-20T03:24:10.040+00:00` / age_days `0.02`
...
- Band: `watch` (raw `watch`)
- Dynamics score: `12.0`
- Published: `2026-08-20T00:42:16.040+00:00` / age_days `0.13`
- Vergleich: Die Dynamik ist sichtbar, aber noch nicht stark genug für Alarm.
- Senna: Beobachten, nicht aufblasen.
...
- Dynamics score: `10.0`
- Published: `2026-08-20T01:30:44+00:00` / age_days `0.1`
...
- Band: `quiet` (raw `quiet`)
- Dynamics score: `7.0`
- Published: `2026-08-20T02:30:54+00:00` / age_days `0.05`
- Vergleich: Die Dynamik wirkt aktuell wie Hintergrundrauschen.
...
- Band: `quiet` (raw `quiet`)
- Dynamics score: `5.0`
- Published: `2026-08-19T21:37:29+00:00` / age_days `0.26`
- Vergleich: Die Dynamik wirkt aktuell wie Hintergrundrauschen.
- Senna: Beobachten, nicht aufblasen.
- Warum: no strong comparative reason
...
- Band: `quiet` (raw `quiet`)
- Dynamics score: `5.0`
- Published: `2026-08-19T20:35:25+00:00` / age_days `0.3`
- Vergleich: Die Dynamik wirkt aktuell wie Hintergrundrauschen.
- Senna: Beobachten, nicht aufblasen.
- Warum: no strong comparative reason
...
- Band: `quiet` (raw `quiet`)
- Dynamics score: `0`
- Published: `2026-06-20T02:49:51+00:00` / age_days `61.04`
- Vergleich: Die Dynamik wirkt aktuell wie Hintergrundrauschen.
- Senna: Beobachten, nicht aufblasen.
