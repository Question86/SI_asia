...
_Generated: 2026-09-05T09:12:33Z_
...
- Dynamics score: `24.9`
- Published: `2026-09-03T11:00:00+00:00` / age_days `1.93`
...
- Dynamics score: `22.5`
- Published: `2026-09-05T07:22:32+00:00` / age_days `0.08`
- Vergleich: Die Dynamik liegt über Normalniveau und verdient aktive Beobachtung.
...
- Band: `strong` (raw `strong`)
- Dynamics score: `22.5`
- Published: `2026-09-05T01:09:44+00:00` / age_days `0.34`
- Vergleich: Die Dynamik liegt über Normalniveau und verdient aktive Beobachtung.
- Senna: Beobachten, nicht aufblasen.
- Warum: momentum delta +3
...
- Band: `strong` (raw `strong`)
- Dynamics score: `22.0`
- Published: `2026-09-05T06:31:31+00:00` / age_days `0.11`
- Vergleich: Die Dynamik liegt über Normalniveau und verdient aktive Beobachtung.
- Senna: Beobachten, nicht aufblasen.
- Warum: momentum delta +3
...
- Band: `strong` (raw `strong`)
- Dynamics score: `21.0`
- Published: `2026-09-05T00:19:26.018+00:00` / age_days `0.37`
- Vergleich: Die Dynamik liegt über Normalniveau und verdient aktive Beobachtung.
- Senna: Beobachten, nicht aufblasen.
...
- Band: `strong` (raw `strong`)
- Dynamics score: `20.5`
- Published: `2026-09-05T00:43:33+00:00` / age_days `0.35`
- Vergleich: Die Dynamik liegt über Normalniveau und verdient aktive Beobachtung.
- Senna: Beobachten, nicht aufblasen.
- Warum: momentum delta +3
- Quelle: https://earthquake.usgs.gov/earthquakes/eventpage/us7000tefx
...
- Dynamics score: `19.9`
- Published: `2026-06-17T20:44:40+00:00` / age_days `79.52`
...
- Dynamics score: `18.0`
- Published: `2026-09-05T07:17:57.040+00:00` / age_days `0.08`
- Vergleich: Die Dynamik ist sichtbar, aber noch nicht stark genug für Alarm.
- Senna: Beobachten, nicht aufblasen.
...
- Band: `watch` (raw `watch`)
- Dynamics score: `18.0`
- Published: `2026-09-05T00:50:28.040+00:00` / age_days `0.35`
- Vergleich: Die Dynamik ist sichtbar, aber noch nicht stark genug für Alarm.
- Senna: Beobachten, nicht aufblasen.
- Warum: early terms: earthquake
- Quelle: https://earthquake.usgs.gov/earthquakes/eventpage/us7000teg7
...
- Band: `watch` (raw `watch`)
- Dynamics score: `17.0`
- Published: `2026-09-05T05:22:26.040+00:00` / age_days `0.16`
- Vergleich: Die Dynamik ist sichtbar, aber noch nicht stark genug für Alarm.
- Senna: Beobachten, nicht aufblasen.
...
- Band: `watch` (raw `watch`)
- Dynamics score: `16.5`
- Published: `2026-09-05T05:29:03+00:00` / age_days `0.16`
- Vergleich: Die Dynamik ist sichtbar, aber noch nicht stark genug für Alarm.
- Senna: Beobachten, nicht aufblasen.
- Warum: momentum delta +3
- Quelle: https://earthquake.usgs.gov/earthquakes/eventpage/us7000tehe
