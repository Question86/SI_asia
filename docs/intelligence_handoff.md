...
_Generated: 2026-08-18T04:43:10Z_
...
- Dynamics score: `26.0`
- Published: `2026-08-18T12:00:00+09:00` / age_days `0.07`
...
- Dynamics score: `24.9`
- Published: `2026-06-19T01:58:32+00:00` / age_days `60.11`
- Vergleich: Die Dynamik liegt über Normalniveau und verdient aktive Beobachtung.
- Senna: Security zuerst. Exposure prüfen, Patchstand sichern, dann erst über Narrative reden.
...
- Band: `strong` (raw `strong`)
- Dynamics score: `20.0`
- Published: `2026-08-18T03:03:15+00:00` / age_days `0.07`
- Vergleich: Die Dynamik liegt über Normalniveau und verdient aktive Beobachtung.
...
- Dynamics score: `18.0`
- Published: `2026-08-18T03:19:14.040+00:00` / age_days `0.06`
...
- Band: `watch` (raw `watch`)
- Dynamics score: `17.0`
- Published: `2026-08-18T01:26:57.040+00:00` / age_days `0.14`
- Vergleich: Die Dynamik ist sichtbar, aber noch nicht stark genug für Alarm.
- Senna: Beobachten, nicht aufblasen.
...
- Band: `watch` (raw `watch`)
- Dynamics score: `13.0`
- Published: `2026-08-18T01:30:11+00:00` / age_days `0.13`
- Vergleich: Die Dynamik ist sichtbar, aber noch nicht stark genug für Alarm.
- Senna: Beobachten, nicht aufblasen.
...
- Dynamics score: `10.0`
- Published: `2026-08-18T01:19:38+00:00` / age_days `0.14`
...
- Band: `quiet` (raw `quiet`)
- Dynamics score: `10.0`
- Published: `2026-08-17T03:27:49+00:00` / age_days `1.05`
- Vergleich: Die Dynamik wirkt aktuell wie Hintergrundrauschen.
- Senna: Beobachten, nicht aufblasen.
- Warum: high terms: 10
...
- Band: `quiet` (raw `quiet`)
- Dynamics score: `9.0`
- Published: `2026-08-18T02:00:12+00:00` / age_days `0.11`
- Vergleich: Die Dynamik wirkt aktuell wie Hintergrundrauschen.
- Senna: Beobachten, nicht aufblasen.
- Warum: no strong comparative reason
...
- Band: `quiet` (raw `quiet`)
- Dynamics score: `4.0`
- Published: `2026-08-17T22:42:32+00:00` / age_days `0.25`
- Vergleich: Die Dynamik wirkt aktuell wie Hintergrundrauschen.
- Senna: Interessant, aber Einzelquellen-AI darf nicht die Lage dominieren.
- Warum: high terms: 10, single-source AI hype brake -8.0, single-source AI cap enforced after phrase recheck
...
- Band: `quiet` (raw `quiet`)
- Dynamics score: `2.0`
- Published: `2026-08-18T01:22:15+00:00` / age_days `0.14`
- Vergleich: Die Dynamik wirkt aktuell wie Hintergrundrauschen.
- Senna: Interessant, aber Einzelquellen-AI darf nicht die Lage dominieren.
