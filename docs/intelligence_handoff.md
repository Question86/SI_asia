...
_Generated: 2026-08-16T20:50:14Z_
...
- Dynamics score: `24.9`
- Published: `2026-06-19T01:58:32+00:00` / age_days `58.79`
...
- Dynamics score: `23.0`
- Published: `2026-08-16T13:57:43.040+00:00` / age_days `0.29`
- Vergleich: Die Dynamik liegt über Normalniveau und verdient aktive Beobachtung.
- Senna: Beobachten, nicht aufblasen.
...
- Band: `strong` (raw `strong`)
- Dynamics score: `23.0`
- Published: `2026-08-16T13:27:48.040+00:00` / age_days `0.31`
- Vergleich: Die Dynamik liegt über Normalniveau und verdient aktive Beobachtung.
- Senna: Beobachten, nicht aufblasen.
- Warum: early terms: earthquake, high terms: 10
...
- Band: `strong` (raw `strong`)
- Dynamics score: `23.0`
- Published: `2026-08-16T11:33:20.040+00:00` / age_days `0.39`
- Vergleich: Die Dynamik liegt über Normalniveau und verdient aktive Beobachtung.
- Senna: Beobachten, nicht aufblasen.
- Warum: early terms: earthquake, high terms: 10
...
- Band: `strong` (raw `strong`)
- Dynamics score: `23.0`
- Published: `2026-08-16T10:50:40.040+00:00` / age_days `0.42`
- Vergleich: Die Dynamik liegt über Normalniveau und verdient aktive Beobachtung.
- Senna: Beobachten, nicht aufblasen.
- Warum: early terms: earthquake, high terms: 10
...
- Band: `strong` (raw `strong`)
- Dynamics score: `23.0`
- Published: `2026-08-16T10:33:42.040+00:00` / age_days `0.43`
- Vergleich: Die Dynamik liegt über Normalniveau und verdient aktive Beobachtung.
- Senna: Beobachten, nicht aufblasen.
- Warum: early terms: earthquake, high terms: 10
...
- Band: `strong` (raw `strong`)
- Dynamics score: `23.0`
- Published: `2026-08-16T03:58:33.040+00:00` / age_days `0.7`
- Vergleich: Die Dynamik liegt über Normalniveau und verdient aktive Beobachtung.
- Senna: Beobachten, nicht aufblasen.
- Warum: early terms: earthquake, high terms: 10
...
- Band: `strong` (raw `strong`)
- Dynamics score: `20.0`
- Published: `2026-08-16T02:47:13+00:00` / age_days `0.75`
- Vergleich: Die Dynamik liegt über Normalniveau und verdient aktive Beobachtung.
...
- Dynamics score: `18.0`
- Published: `2026-08-16T18:00:17.040+00:00` / age_days `0.12`
...
- Band: `watch` (raw `watch`)
- Dynamics score: `17.0`
- Published: `2026-08-16T18:03:10.040+00:00` / age_days `0.12`
- Vergleich: Die Dynamik ist sichtbar, aber noch nicht stark genug für Alarm.
- Senna: Beobachten, nicht aufblasen.
- Warum: early terms: earthquake, high terms: 10
...
- Band: `watch` (raw `watch`)
- Dynamics score: `17.0`
- Published: `2026-08-16T11:25:45.040+00:00` / age_days `0.39`
- Vergleich: Die Dynamik ist sichtbar, aber noch nicht stark genug für Alarm.
- Senna: Beobachten, nicht aufblasen.
- Warum: early terms: earthquake, high terms: 10
