...
_Generated: 2026-09-06T18:14:15Z_
...
- Dynamics score: `24.9`
- Published: `2026-09-06T00:42:44+00:00` / age_days `0.73`
...
- Dynamics score: `24.9`
- Published: `2026-08-31T18:43:10+00:00` / age_days `5.98`
- Vergleich: Die Dynamik liegt über Normalniveau und verdient aktive Beobachtung.
- Senna: Security zuerst. Exposure prüfen, Patchstand sichern, dann erst über Narrative reden.
- Warum: momentum delta +3, baseline z_hint 1.20, high terms: rce, security high-signal: rce, extreme gate: needs multi-source high-signal, official security, or identity relevance
...
- Dynamics score: `21.5`
- Published: `2026-09-06T03:24:46+00:00` / age_days `0.62`
- Vergleich: Die Dynamik liegt über Normalniveau und verdient aktive Beobachtung.
...
- Band: `strong` (raw `strong`)
- Dynamics score: `20.0`
- Published: `2026-06-19T01:58:32+00:00` / age_days `79.68`
- Vergleich: Die Dynamik liegt über Normalniveau und verdient aktive Beobachtung.
- Senna: Beobachten, nicht aufblasen.
...
- Dynamics score: `19.0`
- Published: `2026-09-06T06:08:42+00:00` / age_days `0.5`
...
- Band: `watch` (raw `watch`)
- Dynamics score: `19.0`
- Published: `2026-09-06T11:28:06.040+00:00` / age_days `0.28`
- Vergleich: Die Dynamik ist sichtbar, aber noch nicht stark genug für Alarm.
- Senna: Beobachten, nicht aufblasen.
...
- Band: `watch` (raw `watch`)
- Dynamics score: `18.5`
- Published: `2026-09-03T21:39:57+00:00` / age_days `2.86`
- Vergleich: Die Dynamik ist sichtbar, aber noch nicht stark genug für Alarm.
- Senna: Beobachten, nicht aufblasen.
...
- Band: `watch` (raw `watch`)
- Dynamics score: `18.0`
- Published: `2026-09-06T05:34:11.040+00:00` / age_days `0.53`
- Vergleich: Die Dynamik ist sichtbar, aber noch nicht stark genug für Alarm.
- Senna: Beobachten, nicht aufblasen.
...
- Band: `watch` (raw `watch`)
- Dynamics score: `17.0`
- Published: `2026-09-06T13:10:28.040+00:00` / age_days `0.21`
- Vergleich: Die Dynamik ist sichtbar, aber noch nicht stark genug für Alarm.
- Senna: Beobachten, nicht aufblasen.
- Warum: early terms: earthquake, high terms: 10
...
- Band: `watch` (raw `watch`)
- Dynamics score: `17.0`
- Published: `2026-09-06T12:18:21.040+00:00` / age_days `0.25`
- Vergleich: Die Dynamik ist sichtbar, aber noch nicht stark genug für Alarm.
- Senna: Beobachten, nicht aufblasen.
- Warum: early terms: earthquake, high terms: 10
...
- Band: `watch` (raw `watch`)
- Dynamics score: `17.0`
- Published: `2026-09-06T11:21:12.040+00:00` / age_days `0.29`
- Vergleich: Die Dynamik ist sichtbar, aber noch nicht stark genug für Alarm.
- Senna: Beobachten, nicht aufblasen.
- Warum: early terms: earthquake, high terms: 10
...
- Band: `watch` (raw `watch`)
- Dynamics score: `17.0`
- Published: `2026-09-06T10:56:54.040+00:00` / age_days `0.3`
- Vergleich: Die Dynamik ist sichtbar, aber noch nicht stark genug für Alarm.
- Senna: Beobachten, nicht aufblasen.
- Warum: early terms: earthquake, high terms: 10
